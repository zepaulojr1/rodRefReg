#RODENT REFRESHMENT REGULATOR VERSION 12
...
# fix suggest/push etc. see written notes
...
terminal_output = tk.Text(terminal_frame, height=16)
...
welcome_label.pack(fill='x', padx=20, pady=3)
...
#               # adds padding and align to the left for proper UI fitting. padx is responsible for adding horizontal space between the label and en>

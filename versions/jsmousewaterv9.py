#RODENT REFRESHMENT REGULATOR VERSION 0.85
#Last updated 17/05/2024 by JS
# Going to version 9 now, trying to implement advanced settings menu
...
scrollable_frame.grid_rowconfigure(0, weight=0)  # No extra space allocation beyond what's necessary
...
#welcome_label.place(x=0, y=0, height=50)
...
buttons_frame.grid(row=2, column=0, sticky="nw", pady=(0, 0))
...
advanced_settings_frame.grid(row=4, column=0, columnspan=5, sticky='nsew', padx=10, pady=10)
...
#______________________________________________________________________________________________________________________________________________________________________________________________
#__________PROGRAM_CLOSURE_STUFF_______________________________________________________________________________________________________________________________________________________________
#______________________________________________________________________________________________________________________________________________________________________________________________

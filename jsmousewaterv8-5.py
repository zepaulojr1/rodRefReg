 ...
 * Water volume suggestions will always round UP based on the volume increments that your pumps are capable of outputting per trigger. Default>
...
def add_styled_text_single(frame, text):
	text_widget = tk.Text(frame, wrap='word', height=10, font=("Arial", 12), bg=frame.cget("bg"), bd=0, highlightthickness=0)
...
#______________________________________________________________________________________________________________________________________________________________________________________________
#___________HOUSING_FOR__USER_Qs_______________________________________________________________________________________________________________________________________________________________
#______________________________________________________________________________________________________________________________________________________________________________________________
...
#______________________________________________________________________________________________________________________________________________________________________________________________
#________SUGGEST/PUSH/RUN/STOP__BUTTONS________________________________________________________________________________________________________________________________________________________
#______________________________________________________________________________________________________________________________________________________________________________________________

# Button frame
buttons_frame = tk.Frame(scrollable_frame)
buttons_frame.grid(row=2, column=0, sticky="nw", pady=(0, 20))
...
#______________________________________________________________________________________________________________________________________________________________________________________________
#_______RELAY_CHECKBOXES_AND_TRIGGER_FIELDS____________________________________________________________________________________________________________________________________________________
#______________________________________________________________________________________________________________________________________________________________________________________________
...
update_settings_button.grid(row=12, column=0, sticky="w", padx=500, pady=10)  #Change Columnspan if too wide
